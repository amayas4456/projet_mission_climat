...
class Window(tk.Toplevel):
    ...
    def __init__(self, parent):
        ...
        columns = ('code_commune', 'code_departement', 'nom_commune', 'statut_commune', 'altitude_moyenne', 'population', 'superficie', 'code_canton', 'code_arrondissemnt')
        query = """
        ...
        """
        tree = display.createTreeViewDisplayQuery(tab8, columns, query)
        ...
        columns = ('id_renovation', 'code_departement', 'code_region', 'cout_total_ht', 'cout_induit_ht', 'annee_travaux', 'type_logement', 'annee_construction_logement')
        query = """
        ...
        columns = ('id_travaux', 'poste', 'isolant', 'epaisseur', 'surface', 'code_region', 'code_departement', 'cout_total_ht', 'cout_induit_ht', 'annee_travaux', 'type_logement', 'annee_construction_logement') 
        query = """
        ...
        columns = ('id_travaux', 'energie_av_trav', 'energie_installee', 'generateur', 'type_chaud', 'code_region', 'code_departement', 'cout_total_ht', 'cout_induit_ht', 'annee_travaux', 'type_logement', 'annee_construction_logement') 
        query = """
        ...
        columns = ('id_travaux', 'puissance_installee', 'type_panneaux', 'code_region', 'code_departement', 'cout_total_ht', 'cout_induit_ht', 'annee_travaux', 'type_logement', 'annee_construction_logement') 
        query = """
